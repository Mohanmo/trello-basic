...
export const mutations = {
  ...
  addList(state, {
    ...
    state.lists.push(makeLists(title))
  },
  ...
  addItem(state, {
    ...
    list.items.push(makeItems(title, description, date))
  },
  ...
  updateItem(state, {
    ...
    if (item) {
      Object.assign(item, makeItems(title, description, date, itemId))
    }
  },
