  ...
  <div class="board-container">
    <div class="board">
      ...
      <div class="lists-container">
          ...
          <Draggable v-for="(list, listIndex) in lists" :key="list.id">
            <section class="list-container" ref="list" :data-id="list.id">
              ...
              <div class="list-header">
                <span class="list-drag-handle hide-element" >&#x2630;</span>
                {{ list.title }}
              </div>
        ...
        <div class="new-list" style="display:none">
...
export default {
  ...
  created(){
    let initialData = makeData();
    console.log('initialData', initialData)
    this.$store.commit('setInital',initialData);
  },
  ...
  methods: {
    ...
    reset () {
      if (confirm('Are you sure you want to reset the task?')) {
         let initialData = makeData();
         this.$store.commit('setInital',initialData);
